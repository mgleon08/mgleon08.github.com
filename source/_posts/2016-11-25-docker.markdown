---
layout: post
title: "Docker - Dockerfile, Docker Compose, Docker Volumn"
...
## <span id="docker_volumn">Docker Volumn</span>
...
`named volume` 先在 local 建立 volume 在指定
