...
* [Build Drone](https://yeasy.gitbooks.io/docker_practice/cases/ci/drone.html)
* [docs drone](http://docs.drone.io/zh/)
* [plugins.drone.io](http://plugins.drone.io/)
* [用 Drone 打造輕量級容器持續交付平台](https://www.slideshare.net/appleboy/drone-79506886)
